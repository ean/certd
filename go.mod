...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.1167 // indirect
	...
	github.com/exoscale/egoscale v0.60.0 // indirect
	...
	gopkg.in/ns1/ns1-go.v2 v2.5.1 // indirect
